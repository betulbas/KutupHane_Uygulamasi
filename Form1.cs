...
namespace KutupHane_Uygulamasi
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)  //  kitap verisini  getir
        {
            con_string = "Data Source=.;Initial Catalog=Kutuphane;Integrated Security=True";
            ...
            //sqlcom = new MySqlCommand(sql_string, sqlcon);
        ...
        private void button2_Click(object sender, EventArgs e)  // kayıt ekle
        {
            con_string = "Data Source=.;Initial Catalog=Kutuphane;Integrated Security=True";
            //sqlcon = new SqlConnection(con_string);
            sqlcon = new SqlConnection(con_string);
            ...
            sql_string = "";
            sql_string =  sql_string + "insert into kitap (Ad,yazar_Adi,Konu,Fiat,Barkod,sayfa_sayisi,tur) values(";
            ...
            sql_string = sql_string + " " + textBox5.Text + " , ";   //fiat
        ...
        private void button3_Click(object sender, EventArgs e)  // kayıt sil
        {
            con_string = "Data Source=.;Initial Catalog=Kutuphane;Integrated Security=True";
            sqlcon = new SqlConnection(con_string);
            sqlcon.Open();
        ...
        private void button4_Click(object sender, EventArgs e)  //   kayıt duzelt
        {
            con_string = "Data Source=.;Initial Catalog=Kutuphane;Integrated Security=True";
            sqlcon = new SqlConnection(con_string);
            sqlcon.Open();
            ...
            sql_string = sql_string + "Fiat="         + " " + textBox5.Text + "  , ";   //fiat
